...
VITE_API_BASE_URL=https://api.molemotion.dev npm run build
```
...
```
src/
  App.tsx                       four-tab router with lifted PDB + variant state
  main.tsx                      React 19 entry
  index.css                     Tailwind v4 + fonts + fade-in keyframe
  ...
  components/
    ...
    StructureViewer.tsx         3Dmol.js multi-MODEL animation
  views/
    ...
    AboutView.tsx               static intro + architecture diagram
```
